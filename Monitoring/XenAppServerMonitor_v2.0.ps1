...
#if ($silo -eq "SDI W2K8R2 OFI IE11 DES")
#	{
#	$serversilo = "SDI W2K8R2 OFI IE11 DES"
...
$logfilename =    "prueba.txt"
$resultfilename = "resultfilename.html"
...
Get-BrokerMachine | Where-Object {$_.DesktopGroupName -like $serversilo } | select HostedMachineName  | % {
