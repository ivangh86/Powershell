...
ForEach($computername in $servers){
 ...
 ForEach($Computer in $Serveroki){
    ...
    $objVM = New-Object -TypeName psobject
    $objVM | Add-Member -Name "Ping" -Value "ProblemaWMI" -MemberType NoteProperty
    $objVM | Add-Member -Name "Server" -Value $Computer -MemberType NoteProperty
...
#>
    ...
    Foreach ($Computer in $Computername){
        ...
        $wmiObjects | Foreach {
            ...
            $TopProcess = Get-iLPHighCPUProcess -Count 1 #| Select-Object ProcessName |Format-Table  -HideTableHeaders
            #JOB 0
    ...
    $objVM | Add-Member -Name "DiskQueue Average / 10 sec" -Value $jobresult[9] -MemberType NoteProperty
    $objVM | Add-Member -Name "TopProcess" -Value  $jobresult[0] -MemberType NoteProperty
    $objVM | Add-Member -Name "TopProcessPercent" -Value  $jobresult[1] -MemberType NoteProperty
