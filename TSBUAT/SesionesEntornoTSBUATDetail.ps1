...
$Sesiones = Get-XASession -Full | where-object {$Servidores -contains $_.ServerName -and $Estados -contains $_.State -and $_.SessionName -ne "Console"} | Sort-Object $_.ServerName
#Get-XASession -ServerName "XACBSV1025P" -Full | Select -Expand "ClientIPV4"

#LogWrite "Estado ; LogOnTime ; AccountName ; ServerName ; ClientName ; ClientAdress ; App"
