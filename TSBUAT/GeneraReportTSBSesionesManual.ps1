...
$Logfile = "\\capelo\soft_wintel\Citrix\Scripts\TSBUAT\UsersTSB_UAT_Proteo4UK_2018_02_10.txt"
#$CSVfile = "C:\informe_usuarios\TSBUAT\UsersTSB_UAT_Proteo4UK_"+$FechaActual+".csv"
$CSVfile = "C:\informe_usuarios\TSBUAT\UsersTSB_UAT_Proteo4UK_2018_02_10.csv"
...
#C:\informe_usuarios\MailSend\mailsend.exe -f 0901stservers@bancsabadell.com -d adgbs.com -smtp relay.adgbs.com -t  PUJOL.VICENC@sabis.tech,P4UK_Level2@sabadell.co.uk,GOMEZRI@sabis.tech  -cc BS_Wintel_CTX@dxc.com -sub "UsersTSB_UAT_Proteo4UK_2017_12_01" -a  "$CSVfile" -y "csv"
C:\informe_usuarios\MailSend\mailsend.exe -f 0901stservers@bancsabadell.com -d adgbs.com -smtp relay.adgbs.com -t  gomez-hernandez@hpe.com  -cc javier.ramiro-sanchez@hpe.com -sub "UsersTSB_UAT_Proteo4UK_2018_02_10" -a  "$CSVfile" -y "csv"
