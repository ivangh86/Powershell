...
#$servers = (Get-XAServer -Full -WorkerGroupName SB_PROD_SSCC_SF).ServerName 
$servers = get-content "\\capelo\soft_citrix\Temporal\Ivan_Gomez\serverlist.txt"
...
$server
Get-iLPHighCPUProcess -Computername $server -Count 10 |ft -AutoSize
}