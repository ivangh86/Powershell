...
# YYYYYYY::::::::::::::::      PS C:\Program Files\Citrix\Provisioning Services Console> import-module .\McliPSSnapIn.dll
...
$emailFrom = "0901STServers@bancsabadell.com"
$emailTo = "ivan.gomez-hernandez@dxc.com"#,"sacha.thomet@appcloud.ch"
