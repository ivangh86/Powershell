...
<#
.SYNOPSIS
	Creates a complete inventory of a Citrix XenApp 6.5 farm using Microsoft Word 2010, 2013 or 2016.
.DESCRIPTION
...
.PARAMETER To
	...
	If SmtpServer is used, this is a required parameter.
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -PDF 
...
.EXAMPLE
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -Hardware 
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -Software 
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -StartDate "01/01/2014" -EndDate "01/02/2014" 
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -StartDate "01/01/2017" -EndDate "01/01/2017" 
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -StartDate "01/01/2017 21:00:00" -EndDate "01/01/2017 22:00:00" 
...
.EXAMPLE
	PS C:\PSScript .\XA65_Inventory_V43.ps1 -CompanyName "Carl Webster Consulting" -CoverPage "Mod" -UserName "Carl Webster"
...
.EXAMPLE
	PS C:\PSScript .\XA65_Inventory_V43.ps1 -CN "Carl Webster Consulting" -CP "Mod" -UN "Carl Webster"
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -AddDateTime
	...
	Time stamp is in the format of yyyy-MM-dd_HHmm.
	June 1, 2017 at 6PM is 2017-06-01_1800.
	Output filename will be XA65FarmName_2017-06-01_1800.docx
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -PDF -AddDateTime
	...
	Time stamp is in the format of yyyy-MM-dd_HHmm.
	June 1, 2017 at 6PM is 2017-06-01_1800.
	Output filename will be XA65FarmName_2017-06-01_1800.pdf
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -Folder \\FileServer\ShareName
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -SmtpServer mail.domain.tld -From XDAdmin@domain.tld -To ITGroup@domain.tld
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V43.ps1 -SmtpServer smtp.office365.com -SmtpPort 587 -UseSSL -From Webster@CarlWebster.com -To ITGroup@CarlWebster.com
					...
					If($? -and $hotfixes -ne $Null)
					{
						...
						ForEach($hotfix in $hotfixes)
						{
							...
							Switch ($hotfix.HotfixName)
							{
								...
								"XA650W2K8R2X64R07" {$HRP7Installed = $True}
							}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1GIrS9OUh9BlFg0KHRCe1Cw+
# 7vugghtxMIIDtzCCAp+gAwIBAgIQDOfg5RfYRv6P5WD8G/AwOTANBgkqhkiG9w0B
...
# 9w0BCQMxDAYKKwYBBAGCNwIBBDAjBgkqhkiG9w0BCQQxFgQUtr2QTcFcb+cPcZo0
# HrRLxv7gre0wDQYJKoZIhvcNAQEBBQAEggEAAzFu/6rGtFd0D7IcIAymAOyj1uDJ
# SxXAlXxzoB+0d4LaPUIA7DWKpmKuQEHYsygL5PVODNFUS+B0H3DNuhbyiPS3VL9X
# Blwtp7BH8CqioiHP1ogzXocCvLkhkeyM6aYqWjchBdoAJ9wMbmvYMIM3I+uKR83C
# 8bZ/xp9tNmMJEiWtdU7s2rlN44ctZh2FeWOboGGv2+dmhkeqo+PV4W/axC1iPuBb
# L0y/BW8RVuhnlkm/H4Tx4J0jimUfW/dx9BL38bf9rs4fkX71VI+KySuvBZoAHm0d
# kxO5bMaLMv14M0BLyqZtHvTnnzJBGI1O8aRCRcMiNPU2SO1+WJlASxBy6qGCAg8w
...
# 9w0BCQUxDxcNMTcwMzA1MjEyODAxWjAjBgkqhkiG9w0BCQQxFgQUPxwh6iyGxq+9
# qpanEtRbw5NIn70wDQYJKoZIhvcNAQEBBQAEggEAF4sB9YB7vJMC0TkZ5E/F2xEP
# 7MO1MBwXi/ZAdKCs3e2iHDTkE1hONlVF39/mt3c5wbD2rOyPWQ6euvKhnIWPgYnp
# TQROPc54A/T3xyiL1/ybBRGi7FjDn1E+w5st06WbBtQauf/G0JuhMs6ZCdiFd62f
# ioAvTi67Ee2ppnIuRr0u6eXhLeEAi2SDdSK63W9gXqP7/OEBiNyCn07AgeLrWR/X
# HMz6Ssar9nMZEFDREqIOfbXBMz+x4PziKnxl0iDaxcJMx7I6Uad9BfrKp6u0tl9X
# OOaiY+9SANZNxnagqhHl6jJQJHdp+4KM1Iv9dd4fSLApZuVeFuy3BUhHdsg5UQ==
