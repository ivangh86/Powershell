...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V42.ps1 -Folder \\FileServer\ShareName
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V42.ps1 -SmtpServer mail.domain.tld -From XDAdmin@domain.tld -To ITGroup@domain.tld
...
.EXAMPLE
	PS C:\PSScript > .\XA65_Inventory_V42.ps1 -SmtpServer smtp.office365.com -SmtpPort 587 -UseSSL -From Webster@CarlWebster.com -To ITGroup@CarlWebster.com
			...
			If(!$Summary)
			{
				...
				If($SvrOnline)
				{
					...
					If($? -and $hotfixes -ne $Null)
					{
						...
						#hotfix lists are from CTX129229 dated 28-SEP-2015
						...
						If($HRP6Installed)
						{
							$RecommendedList = @(XA650R06W2K8R2X64001)
						}
						ElseIf($HRP5Installed)
						{
							$RecommendedList = @("XA650W2K8R2X64R06", "XA650R05W2K8R2X64020", "XA650R05W2K8R2X64025")
						}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCwyjTfuAiYROQNdtREFGinjh
# BiWgghtxMIIDtzCCAp+gAwIBAgIQDOfg5RfYRv6P5WD8G/AwOTANBgkqhkiG9w0B
...
# 9w0BCQMxDAYKKwYBBAGCNwIBBDAjBgkqhkiG9w0BCQQxFgQU5WKcVoD98Brocd5a
# ZK8eiIu87+swDQYJKoZIhvcNAQEBBQAEggEASnG16GSRaZ5df2YXHmCokpslzOKA
# /pfzP0gfjysLwI8KMAQGgUflqogJSWekXFMLwJ6X6i5vXYbswCRdxxR1QECYDiKZ
# qD3NXukmn7o7ZogDZDFLrHiAN6g2Y+nG8x3RnuRTFiJnY9Nro7Pkp8CyhhGEj1mT
# +6OeIfbmUVNmLxa/ZZALfKZZ+2MUjQUqlXpxT1feiw0ddaxd1XLbx44gmWjB7XUt
# DZotYdZcm/x1Pga9dvmsEXS/OC7vIJPC5QbiV3UPIGexegdr1KbdVkcQSIQmx5e1
# 1xNQ3qaVj+scLhqd4j8JaPPKAtnu7WGWsQRhDvTar93z7NxxgjzBtshHDKGCAg8w
...
# 9w0BCQUxDxcNMTYwMjA5MjEzNzA3WjAjBgkqhkiG9w0BCQQxFgQUFfzTmYNqDUv1
# TMGqyax8TvJvCQEwDQYJKoZIhvcNAQEBBQAEggEAnmpIiRjzanGnTEjCz2gajAVp
# 9Jfxj8yNCPo/2bmibanXIW6PLgmj27SrStKtkbzq0E8Ou3d/146rDMyuucim5YuX
# vPuWVBdunvts8p0BSVsKgAept6iOxuQmfbY/v/xwESJnwMGA3RSqAXezW2TlDqPv
# d8RjLIy85lhTPKnlDBrQ4sDXfZY1YsK0o+o/BVdHabaUmKDH5hJjf0tvhBb5Jy+u
# AQE/6YRNDO+NwJqZb6+n4Yp6uR/OetGdnb2iOmzwTw7Vz6cPvnGS9oSVr7tEk8Tm
# WYHG9UBzXaNnd2danrJX4MnovU1pkLR3l1E8aq4hm+nJKHcpVglc4ENFCT9wUg==
