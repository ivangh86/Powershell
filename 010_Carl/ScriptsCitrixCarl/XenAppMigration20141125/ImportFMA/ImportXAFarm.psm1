...
function Add-DomainUsers
{
    ...
    if ($userList.Count -gt 5)
    {
        $log = [string]::Format('Set-BrokerAccessPolicyRule -Name "{0}" -IncludedUsers "{1}"...', $rulename, $userName)
    }
    else
    {
        $log = [string]::Format('Set-BrokerAccessPolicyRule -Name "{0}" -IncludedUsers "{1}"', $rulename, $userList)
    }
    Write-LogFile $log 2
    try
    {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUmGpsW+3rAt6hQe6Gek0xdpcZ
# rLigghQGMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# SIb3DQEJBDEWBBQmmB0pSrmrZ3Vo5kt9p/ScGlKUIDA8BgorBgEEAYI3AgEMMS4w
# LKAYgBYAQwBpAHQAcgBpAHgAIABGAGkAbABloRCADnd3dy5jaXRyaXguY29tMA0G
# CSqGSIb3DQEBAQUABIIBAEiPCZsEiWdI/oDEBW3wrSMPGDZNuvDCwrnEB3W6pBSD
# pgxux/m5y20GCShETqePtXUn+oXnSNX7zwib4AiSKv6yWBvdk/9ygaG5cjO5qB+1
# nomTMhFwZcCNGgxlN8JnaHLJe98+7kTA5M7WA+bkekvfIF3wtyrhqNQAj/h4bh7K
# PLA8ebRe8mCjUF6BEnjd5cZrehI3tfysORRvEz4u52EjmhqDJW5GmmBMR4pbixRL
# TuXTdR/EBfMRFA4Ic3vemh92uvciKcNE/Fb3iyn/pvYcQyBZpn54F2njL4RIFlnH
# x5vJNU3fg9c8inkTgMbHtBgVe66jyyaTfo9vDir2KKihggILMIICBwYJKoZIhvcN
...
# MjAxNTMzWjAjBgkqhkiG9w0BCQQxFgQUFoUkuzFf2rTo5R2bTA2IRYJpFdkwDQYJ
# KoZIhvcNAQEBBQAEggEAIQjGEMZ6ei5SUFv2R5ove91JSLMoD2iXu/zPplLRLNpb
# kq3Q/hM5WNLmy9YbKCaJd6whaTOjn9dpynAAGRTExRFRTd5WHnGxCjb3AqHS9Vo8
# DZXgmY11dKQ7g0MMnIVd/eZibkVq3EE3P/2MW/ogVX4+KMaOLC7J93rf+KOrBLzl
# YCYXYtC3UuGgSVPLnkouT4R+l8+2FYXCSEBYs4rk82OF3BrR95+Kd5wF28lcE1Pq
# dmB06mTkcQ8drQlehlUrh8HdmKzYUgMB4M24H8oWjTIZ0JChG556k7EioY2+GC+Y
# ZO86da4zjDVXhWpD1M8JVTe0bF4iGbtZGcxyNuwcfg==
