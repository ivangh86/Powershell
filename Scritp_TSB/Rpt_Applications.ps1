...
#*************************************************************
# 
#  Catalogo de Aplicaciones TSB UK APPv
#  v 1.0 - 16/03/18 - Ivan Gomez
#*************************************************************
...
$vBrokerApplications = Get-BrokerApplication -MaxRecordCount 1000 |Where-Object {$_.machineConfigurationNames -ne ""} | Sort-Object -Property PublishedName | Select ApplicationName,Enabled,AdminFolderName,CommandLineExecutable,AssociatedUserFullNames,AllAssociatedDesktopGroupUids
...
"<p align=Center><font size=6 face=Bodoni MT color=#003333><B>Catálogo de Aplicaciones TSB UK APPv</B></font></p>" | Out-File $vRpt_Applications_html_Temp -Append
